...
namespace PaypalClasslib\Db;

use PaypalClasslib\Db\ObjectModelDefinition;
use PaypalClasslib\Db\DbTableDefinitionModel;
use PaypalClasslib\Db\DbTableDefinitionRelation;
use PaypalClasslib\Db\DbSchema;
use PaypalClasslib\Db\DbTable;
...
class ObjectModelExtension
{
    ...
    /**
     * @return PaypalClasslib\Db\ObjectModelDefinition (as an array collection object)
     */
    ...
    /**
     * @param PaypalClasslib\Db\DbSchema $schema
     * @return bool
     */
