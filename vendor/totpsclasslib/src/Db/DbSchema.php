...
{
    /**
     * @var PaypalClasslib\Db\ObjectModelDefinition
     */
    protected $def;
    ...
    /**
     * Register PaypalClasslib\Db\ObjectModelDefinition and table (internal) ID
     * @param PaypalClasslib\Db\ObjectModelDefinition $def
     * @param string                $id
     */
     ...
     * @param PaypalClasslib\Db\DbTable $table
     * @return PaypalClasslib\Db\DbTable
     */
